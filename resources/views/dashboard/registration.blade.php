...
<head>
    ...
    <title>Cardio Rescue || Registration</title>
    ...
    <div class="register-box">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body register-card-body">
                ...
                <form action="{{route('registration')}}" method="post">
                    ...
                    <div class="input-group mb-1">
                        <div class="form-floating">
                            ...
                            <label for="registerFullName">User Name</label>
                        </div>
                ...
                <!-- /.social-auth-links -->
                <p class="mb-0">
                    <a href="login.html" class="link-primary text-center"> I already have a member </a>
                </p>
            </div>
            <!-- /.register-card-body -->
        </div>
